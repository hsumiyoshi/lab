...
- 因子: 日射予報 173 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -388 W/m2（普段より曇る方向。判定時の直近28日平均 561、判定は絶対値 388 vs 閾値 196）
...
- 因子: 日射予報 546 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 +15 W/m2（普段より晴れる方向。判定時の直近28日平均 530、判定は絶対値 15 vs 閾値 196）
...
- 因子: 日射予報 373 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -188 W/m2（普段より曇る方向。判定時の直近28日平均 561、判定は絶対値 188 vs 閾値 196）
