...
- 因子: 日射予報 346 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -290 W/m2（普段より曇る方向。直近28日平均 635、判定は絶対値 297 vs 閾値 195）
...
- 因子: 日射予報 670 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 +34 W/m2（普段より晴れる方向。直近28日平均 635、判定は絶対値 0 vs 閾値 194）
...
- 因子: 日射予報 649 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 +14 W/m2（普段より晴れる方向。直近28日平均 635、判定は絶対値 1 vs 閾値 195）
