...
- 因子: 日射予報 448 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -70 W/m2（普段より曇る方向。直近28日平均 519、判定は絶対値 90 vs 閾値 198）
...
- 因子: 日射予報 175 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -343 W/m2（普段より曇る方向。直近28日平均 519、判定は絶対値 363 vs 閾値 198）
...
- 因子: 日射予報 173 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -346 W/m2（普段より曇る方向。直近28日平均 519、判定は絶対値 388 vs 閾値 196）
...
- 因子: 日射予報 546 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 +27 W/m2（普段より晴れる方向。直近28日平均 519、判定は絶対値 15 vs 閾値 196）
...
- 因子: 日射予報 373 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -146 W/m2（普段より曇る方向。直近28日平均 519、判定は絶対値 188 vs 閾値 196）
...
- 因子: 日射予報 456 W/m2 / 実測 512 / 乖離 -67 W/m2（普段より曇る方向。直近28日平均 522、判定は絶対値 133 vs 閾値 195）
...
- 因子: 日射予報 198 W/m2 / 実測 346 / 乖離 -335 W/m2（普段より曇る方向。直近28日平均 532、判定は絶対値 391 vs 閾値 195）
...
- 因子: 日射予報 350 W/m2 / 実測 432 / 乖離 -188 W/m2（普段より曇る方向。直近28日平均 538、判定は絶対値 239 vs 閾値 195）
...
- 因子: 日射予報 198 W/m2 / 実測 408 / 乖離 -344 W/m2（普段より曇る方向。直近28日平均 541、判定は絶対値 416 vs 閾値 195）
...
- 因子: 日射予報 201 W/m2 / 実測 379 / 乖離 -347 W/m2（普段より曇る方向。直近28日平均 548、判定は絶対値 412 vs 閾値 195）
...
- 因子: 日射予報 141 W/m2 / 実測 319 / 乖離 -419 W/m2（普段より曇る方向。直近28日平均 561、判定は絶対値 472 vs 閾値 195）
...
- 因子: 日射予報 191 W/m2 / 実測 373 / 乖離 -377 W/m2（普段より曇る方向。直近28日平均 568、判定は絶対値 440 vs 閾値 194）
...
- 因子: 日射予報 259 W/m2 / 実測 569 / 乖離 -313 W/m2（普段より曇る方向。直近28日平均 572、判定は絶対値 372 vs 閾値 194）
...
- 因子: 日射予報 156 W/m2 / 実測 196 / 乖離 -433 W/m2（普段より曇る方向。直近28日平均 589、判定は絶対値 475 vs 閾値 194）
...
- 因子: 日射予報 179 W/m2 / 実測 218 / 乖離 -427 W/m2（普段より曇る方向。直近28日平均 606、判定は絶対値 467 vs 閾値 194）
...
- 因子: 日射予報 493 W/m2 / 実測 599 / 乖離 -117 W/m2（普段より曇る方向。直近28日平均 610、判定は絶対値 153 vs 閾値 194）
...
- 因子: 日射予報 497 W/m2 / 実測 563 / 乖離 -117 W/m2（普段より曇る方向。直近28日平均 613、判定は絶対値 149 vs 閾値 194）
...
- 因子: 日射予報 555 W/m2 / 実測 521 / 乖離 -60 W/m2（普段より曇る方向。直近28日平均 615、判定は絶対値 80 vs 閾値 195）
...
- 因子: 日射予報 451 W/m2 / 実測 538 / 乖離 -168 W/m2（普段より曇る方向。直近28日平均 619、判定は絶対値 184 vs 閾値 195）
...
- 因子: 日射予報 331 W/m2 / 実測 358 / 乖離 -300 W/m2（普段より曇る方向。直近28日平均 631、判定は絶対値 311 vs 閾値 195）
...
- 因子: 日射予報 346 W/m2 / 実測 425 / 乖離 -299 W/m2（普段より曇る方向。直近28日平均 645、判定は絶対値 297 vs 閾値 195）
...
- 因子: 日射予報 670 W/m2 / 実測 699 / 乖離 +28 W/m2（普段より晴れる方向。直近28日平均 641、判定は絶対値 0 vs 閾値 194）
...
- 因子: 日射予報 649 W/m2 / 実測 709 / 乖離 +13 W/m2（普段より晴れる方向。直近28日平均 637、判定は絶対値 1 vs 閾値 195）
...
- 因子: 日射予報 578 W/m2 / 実測 675 / 乖離 -59 W/m2（普段より曇る方向。直近28日平均 637、判定は絶対値 81 vs 閾値 195）
...
- 因子: 日射予報 480 W/m2 / 実測 629 / 乖離 -160 W/m2（普段より曇る方向。直近28日平均 639、判定は絶対値 179 vs 閾値 195）
...
- 因子: 日射予報 567 W/m2 / 実測 686 / 乖離 -75 W/m2（普段より曇る方向。直近28日平均 643、判定は絶対値 91 vs 閾値 194）
