...
- 因子: 日射予報 259 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -354 W/m2（普段より曇る方向。直近28日平均 613、判定は絶対値 372 vs 閾値 194）
...
- 因子: 日射予報 156 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -457 W/m2（普段より曇る方向。直近28日平均 613、判定は絶対値 475 vs 閾値 194）
...
- 因子: 日射予報 179 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -434 W/m2（普段より曇る方向。直近28日平均 613、判定は絶対値 467 vs 閾値 194）
...
- 因子: 日射予報 493 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -120 W/m2（普段より曇る方向。直近28日平均 613、判定は絶対値 153 vs 閾値 194）
...
- 因子: 日射予報 497 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -117 W/m2（普段より曇る方向。直近28日平均 613、判定は絶対値 149 vs 閾値 194）
