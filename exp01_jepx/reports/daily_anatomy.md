...
- 因子: 日射予報 578 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -71 W/m2（普段より曇る方向。直近28日平均 648、判定は絶対値 81 vs 閾値 195）
...
- 因子: 日射予報 480 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -169 W/m2（普段より曇る方向。直近28日平均 648、判定は絶対値 179 vs 閾値 195）
...
- 因子: 日射予報 567 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -81 W/m2（普段より曇る方向。直近28日平均 648、判定は絶対値 91 vs 閾値 194）
...
- 因子: 日射予報 615 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -34 W/m2（普段より曇る方向。直近28日平均 648、判定は絶対値 47 vs 閾値 194）
...
- 因子: 日射予報 560 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -88 W/m2（普段より曇る方向。直近28日平均 648、判定は絶対値 110 vs 閾値 194）
