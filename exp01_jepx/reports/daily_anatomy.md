...
- 因子: 日射予報 480 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -173 W/m2（普段より曇る方向。直近28日平均 653、判定は絶対値 179 vs 閾値 195）
...
- 因子: 日射予報 567 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -86 W/m2（普段より曇る方向。直近28日平均 653、判定は絶対値 91 vs 閾値 194）
...
- 因子: 日射予報 615 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -38 W/m2（普段より曇る方向。直近28日平均 653、判定は絶対値 47 vs 閾値 194）
...
- 因子: 日射予報 560 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -93 W/m2（普段より曇る方向。直近28日平均 653、判定は絶対値 110 vs 閾値 194）
...
- 因子: 日射予報 390 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -262 W/m2（普段より曇る方向。直近28日平均 653、判定は絶対値 284 vs 閾値 194）
