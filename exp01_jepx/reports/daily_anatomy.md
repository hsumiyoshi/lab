...
- 因子: 日射予報 546 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 +8 W/m2（普段より晴れる方向。直近28日平均 538、判定は絶対値 15 vs 閾値 196）
...
- 因子: 日射予報 373 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -165 W/m2（普段より曇る方向。直近28日平均 538、判定は絶対値 188 vs 閾値 196）
...
- 因子: 日射予報 456 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -82 W/m2（普段より曇る方向。直近28日平均 538、判定は絶対値 133 vs 閾値 195）
...
- 因子: 日射予報 198 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -340 W/m2（普段より曇る方向。直近28日平均 538、判定は絶対値 391 vs 閾値 195）
...
- 因子: 日射予報 350 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -188 W/m2（普段より曇る方向。直近28日平均 538、判定は絶対値 239 vs 閾値 195）
