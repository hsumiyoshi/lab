...
- 因子: 日射予報 198 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -363 W/m2（普段より曇る方向。直近28日平均 561、判定は絶対値 391 vs 閾値 195）
...
- 因子: 日射予報 350 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -210 W/m2（普段より曇る方向。直近28日平均 561、判定は絶対値 239 vs 閾値 195）
...
- 因子: 日射予報 198 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -363 W/m2（普段より曇る方向。直近28日平均 561、判定は絶対値 416 vs 閾値 195）
...
- 因子: 日射予報 201 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -360 W/m2（普段より曇る方向。直近28日平均 561、判定は絶対値 412 vs 閾値 195）
...
- 因子: 日射予報 141 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -419 W/m2（普段より曇る方向。直近28日平均 561、判定は絶対値 472 vs 閾値 195）
