...
- 因子: 日射予報 567 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -92 W/m2（普段より曇る方向。直近28日平均 659、判定は絶対値 91 vs 閾値 194）
...
- 因子: 日射予報 615 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -44 W/m2（普段より曇る方向。直近28日平均 659、判定は絶対値 47 vs 閾値 194）
...
- 因子: 日射予報 560 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -99 W/m2（普段より曇る方向。直近28日平均 659、判定は絶対値 110 vs 閾値 194）
...
- 因子: 日射予報 390 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -268 W/m2（普段より曇る方向。直近28日平均 659、判定は絶対値 284 vs 閾値 194）
...
- 因子: 日射予報 324 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -335 W/m2（普段より曇る方向。直近28日平均 659、判定は絶対値 347 vs 閾値 194）
