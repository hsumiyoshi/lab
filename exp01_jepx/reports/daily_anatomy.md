...
- 因子: 日射予報 493 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -138 W/m2（普段より曇る方向。直近28日平均 631、判定は絶対値 153 vs 閾値 194）
...
- 因子: 日射予報 497 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -134 W/m2（普段より曇る方向。直近28日平均 631、判定は絶対値 149 vs 閾値 194）
...
- 因子: 日射予報 555 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -76 W/m2（普段より曇る方向。直近28日平均 631、判定は絶対値 80 vs 閾値 195）
...
- 因子: 日射予報 451 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -180 W/m2（普段より曇る方向。直近28日平均 631、判定は絶対値 184 vs 閾値 195）
...
- 因子: 日射予報 331 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -300 W/m2（普段より曇る方向。直近28日平均 631、判定は絶対値 311 vs 閾値 195）
