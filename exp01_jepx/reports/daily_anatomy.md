...
- 因子: 日射予報 451 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -195 W/m2（普段より曇る方向。直近28日平均 646、判定は絶対値 184 vs 閾値 195）
...
- 因子: 日射予報 331 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -315 W/m2（普段より曇る方向。直近28日平均 646、判定は絶対値 311 vs 閾値 195）
...
- 因子: 日射予報 346 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -300 W/m2（普段より曇る方向。直近28日平均 646、判定は絶対値 297 vs 閾値 195）
