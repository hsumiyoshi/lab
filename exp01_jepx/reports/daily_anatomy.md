...
- 因子: 日射予報 201 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -388 W/m2（普段より曇る方向。直近28日平均 589、判定は絶対値 412 vs 閾値 195）
...
- 因子: 日射予報 141 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -448 W/m2（普段より曇る方向。直近28日平均 589、判定は絶対値 472 vs 閾値 195）
...
- 因子: 日射予報 191 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -398 W/m2（普段より曇る方向。直近28日平均 589、判定は絶対値 440 vs 閾値 194）
...
- 因子: 日射予報 259 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -330 W/m2（普段より曇る方向。直近28日平均 589、判定は絶対値 372 vs 閾値 194）
...
- 因子: 日射予報 156 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 -433 W/m2（普段より曇る方向。直近28日平均 589、判定は絶対値 475 vs 閾値 194）
