...
- 因子: 日射予報 471 W/m2 / 実測 未確定（実測は約5日遅れ） / 乖離 +10 W/m2（普段より晴れる方向。判定時の直近28日平均 461、判定は絶対値 10 vs 閾値 200）
...
- 因子: 日射予報 232 W/m2 / 実測 354 / 乖離 -286 W/m2（普段より曇る方向。判定時の直近28日平均 519、判定は絶対値 286 vs 閾値 199）
...
- 因子: 日射予報 231 W/m2 / 実測 383 / 乖離 -288 W/m2（普段より曇る方向。判定時の直近28日平均 519、判定は絶対値 288 vs 閾値 199）
...
- 因子: 日射予報 271 W/m2 / 実測 443 / 乖離 -247 W/m2（普段より曇る方向。判定時の直近28日平均 519、判定は絶対値 247 vs 閾値 199）
...
- 因子: 日射予報 324 W/m2 / 実測 438 / 乖離 -214 W/m2（普段より曇る方向。判定時の直近28日平均 538、判定は絶対値 214 vs 閾値 198）
...
- 因子: 日射予報 448 W/m2 / 実測 628 / 乖離 -90 W/m2（普段より曇る方向。判定時の直近28日平均 538、判定は絶対値 90 vs 閾値 198）
...
- 因子: 日射予報 175 W/m2 / 実測 298 / 乖離 -363 W/m2（普段より曇る方向。判定時の直近28日平均 538、判定は絶対値 363 vs 閾値 198）
...
- 因子: 日射予報 173 W/m2 / 実測 382 / 乖離 -388 W/m2（普段より曇る方向。判定時の直近28日平均 561、判定は絶対値 388 vs 閾値 196）
...
- 因子: 日射予報 546 W/m2 / 実測 560 / 乖離 +15 W/m2（普段より晴れる方向。判定時の直近28日平均 530、判定は絶対値 15 vs 閾値 196）
...
- 因子: 日射予報 373 W/m2 / 実測 491 / 乖離 -188 W/m2（普段より曇る方向。判定時の直近28日平均 561、判定は絶対値 188 vs 閾値 196）
...
- 因子: 日射予報 456 W/m2 / 実測 512 / 乖離 -133 W/m2（普段より曇る方向。判定時の直近28日平均 589、判定は絶対値 133 vs 閾値 195）
...
- 因子: 日射予報 198 W/m2 / 実測 346 / 乖離 -391 W/m2（普段より曇る方向。判定時の直近28日平均 589、判定は絶対値 391 vs 閾値 195）
...
- 因子: 日射予報 350 W/m2 / 実測 432 / 乖離 -239 W/m2（普段より曇る方向。判定時の直近28日平均 589、判定は絶対値 239 vs 閾値 195）
...
- 因子: 日射予報 198 W/m2 / 実測 408 / 乖離 -416 W/m2（普段より曇る方向。判定時の直近28日平均 613、判定は絶対値 416 vs 閾値 195）
...
- 因子: 日射予報 201 W/m2 / 実測 379 / 乖離 -412 W/m2（普段より曇る方向。判定時の直近28日平均 613、判定は絶対値 412 vs 閾値 195）
...
- 因子: 日射予報 141 W/m2 / 実測 319 / 乖離 -472 W/m2（普段より曇る方向。判定時の直近28日平均 613、判定は絶対値 472 vs 閾値 195）
...
- 因子: 日射予報 191 W/m2 / 実測 373 / 乖離 -440 W/m2（普段より曇る方向。判定時の直近28日平均 631、判定は絶対値 440 vs 閾値 194）
...
- 因子: 日射予報 259 W/m2 / 実測 569 / 乖離 -372 W/m2（普段より曇る方向。判定時の直近28日平均 631、判定は絶対値 372 vs 閾値 194）
...
- 因子: 日射予報 156 W/m2 / 実測 196 / 乖離 -475 W/m2（普段より曇る方向。判定時の直近28日平均 631、判定は絶対値 475 vs 閾値 194）
...
- 因子: 日射予報 179 W/m2 / 実測 218 / 乖離 -467 W/m2（普段より曇る方向。判定時の直近28日平均 646、判定は絶対値 467 vs 閾値 194）
...
- 因子: 日射予報 493 W/m2 / 実測 599 / 乖離 -153 W/m2（普段より曇る方向。判定時の直近28日平均 646、判定は絶対値 153 vs 閾値 194）
...
- 因子: 日射予報 497 W/m2 / 実測 563 / 乖離 -149 W/m2（普段より曇る方向。判定時の直近28日平均 646、判定は絶対値 149 vs 閾値 194）
...
- 因子: 日射予報 555 W/m2 / 実測 521 / 乖離 -80 W/m2（普段より曇る方向。判定時の直近28日平均 635、判定は絶対値 80 vs 閾値 195）
...
- 因子: 日射予報 451 W/m2 / 実測 538 / 乖離 -184 W/m2（普段より曇る方向。判定時の直近28日平均 635、判定は絶対値 184 vs 閾値 195）
...
- 因子: 日射予報 331 W/m2 / 実測 358 / 乖離 -311 W/m2（普段より曇る方向。判定時の直近28日平均 643、判定は絶対値 311 vs 閾値 195）
...
- 因子: 日射予報 346 W/m2 / 実測 425 / 乖離 -297 W/m2（普段より曇る方向。判定時の直近28日平均 643、判定は絶対値 297 vs 閾値 195）
...
- 因子: 日射予報 670 W/m2 / 実測 699 / 乖離 +0 W/m2（普段より晴れる方向。判定時の直近28日平均 669、判定は絶対値 0 vs 閾値 194）
...
- 因子: 日射予報 649 W/m2 / 実測 709 / 乖離 +1 W/m2（普段より晴れる方向。判定時の直近28日平均 648、判定は絶対値 1 vs 閾値 195）
...
- 因子: 日射予報 578 W/m2 / 実測 675 / 乖離 -81 W/m2（普段より曇る方向。判定時の直近28日平均 659、判定は絶対値 81 vs 閾値 195）
...
- 因子: 日射予報 480 W/m2 / 実測 629 / 乖離 -179 W/m2（普段より曇る方向。判定時の直近28日平均 659、判定は絶対値 179 vs 閾値 195）
...
- 因子: 日射予報 567 W/m2 / 実測 686 / 乖離 -91 W/m2（普段より曇る方向。判定時の直近28日平均 658、判定は絶対値 91 vs 閾値 194）
...
- 因子: 日射予報 615 W/m2 / 実測 707 / 乖離 -47 W/m2（普段より曇る方向。判定時の直近28日平均 662、判定は絶対値 47 vs 閾値 194）
...
- 因子: 日射予報 560 W/m2 / 実測 653 / 乖離 -110 W/m2（普段より曇る方向。判定時の直近28日平均 670、判定は絶対値 110 vs 閾値 194）
...
- 因子: 日射予報 390 W/m2 / 実測 631 / 乖離 -284 W/m2（普段より曇る方向。判定時の直近28日平均 674、判定は絶対値 284 vs 閾値 194）
...
- 因子: 日射予報 324 W/m2 / 実測 519 / 乖離 -347 W/m2（普段より曇る方向。判定時の直近28日平均 671、判定は絶対値 347 vs 閾値 194）
...
- 因子: 日射予報 455 W/m2 / 実測 622 / 乖離 -215 W/m2（普段より曇る方向。判定時の直近28日平均 670、判定は絶対値 215 vs 閾値 194）
...
- 因子: 日射予報 345 W/m2 / 実測 626 / 乖離 -325 W/m2（普段より曇る方向。判定時の直近28日平均 669、判定は絶対値 325 vs 閾値 194）
