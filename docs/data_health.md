...
生成: 2026-09-19 01:58 JST / 登録 26件 / 合計 25.5MB
...
| データ | 格 | 形式 | サイズ | 状態 | 出所 |
|---|---|---|---|---|---|
| `exp01_jepx/reports/forward_ledger.csv` | A | append | 6KB | OK | 自前の採点 |
...
| `exp10_disaster/data/events.json` | A | append | 2.9MB | OK | GDACS RSS |
...
| `collector/data/kyuden_curtail.json` | A | append | 15KB | OK | 九電でんき予報（収集基盤） |
