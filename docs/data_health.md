...
生成: 2026-08-24 22:53 JST / 登録 26件 / 合計 23.0MB
...
| データ | 格 | 形式 | サイズ | 状態 | 出所 |
|---|---|---|---|---|---|
| `exp01_jepx/reports/forward_ledger.csv` | A | append | 2KB | OK | 自前の採点 |
| `exp05_quake/archive/quakes.csv` | A | append | 50KB | OK | P2P地震情報API |
...
| `exp10_disaster/data/events.json` | A | append | 838KB | 変化なし | GDACS RSS |
...
| `collector/data/tohan_books.json` | A | append | 3KB | 変化なし | トーハン週間ベストセラー（収集基盤） |
| `exp07_satellite/data/tsumagoi_ndvi.csv` | B | append | 3KB | 変化なし | Sentinel-2 AWS公開COG |
| `exp01_jepx/data/spot_2026.csv` | C | append | 1.7MB | 変化なし | JEPX公式CSV |
| `exp01_jepx/data/spot_2025.csv` | C | append | 4.3MB | 変化なし | JEPX公式CSV |
| `exp01_jepx/data/weather_actual.csv` | C | append | 24KB | OK | Open-Meteo archive |
