...
生成: 2026-09-16 02:31 JST / 登録 26件 / 合計 25.1MB
...
| `exp05_quake/archive/quakes.csv` | A | append | 58KB | 変化なし | P2P地震情報API |
| `exp03_weather/data/ledger.json` | A | append | 5KB | 変化なし | 自前の採点 |
| `exp08_curtail/data/outlook_history.json` | A | append | 1KB | OK | 九電でんき予報 |
| `exp08_curtail/data/ledger.json` | A | append | 1KB | 変化なし | 自前の採点 |
| `exp10_disaster/data/events.json` | A | append | 2.6MB | OK | GDACS RSS |
...
| `collector/data/kyuden_curtail.json` | A | append | 13KB | OK | 九電でんき予報（収集基盤） |
| `collector/data/tohan_books.json` | A | append | 13KB | OK | トーハン週間ベストセラー（収集基盤） |
