...
生成: 2026-09-25 02:47 JST / 登録 26件 / 合計 26.0MB
...
| `collector/data/tohan_books.json` | A | append | 16KB | OK | トーハン週間ベストセラー（収集基盤） |
...
| `exp02_vegetable/data/veg_34400.csv` | C | append | 146KB | 変化なし | 同上 |
