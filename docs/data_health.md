...
生成: 2026-09-11 01:55 JST / 登録 26件 / 合計 24.8MB
...
| データ | 格 | 形式 | サイズ | 状態 | 出所 |
|---|---|---|---|---|---|
| `exp01_jepx/reports/forward_ledger.csv` | A | append | 5KB | OK | 自前の採点 |
| `exp05_quake/archive/quakes.csv` | A | append | 55KB | 変化なし | P2P地震情報API |
| `exp03_weather/data/ledger.json` | A | append | 4KB | OK | 自前の採点 |
| `exp08_curtail/data/outlook_history.json` | A | append | 1KB | OK | 九電でんき予報 |
| `exp08_curtail/data/ledger.json` | A | append | 1KB | 変化なし | 自前の採点 |
| `exp10_disaster/data/events.json` | A | append | 2.3MB | OK | GDACS RSS |
| `exp10_disaster/data/ledger.json` | A | append | 2KB | OK | 自前の採点 |
| `exp10_disaster/data/firms_daily.json` | A | append | 0KB | OK | NASA FIRMS（要キー） |
| `exp11_books/data/rankings.json` | A | append | 8KB | OK | トーハン週間ベストセラー |
| `exp11_books/data/ledger.json` | A | append | 1KB | OK | 自前の採点 |
| `collector/data/kyuden_curtail.json` | A | append | 11KB | OK | 九電でんき予報（収集基盤） |
| `collector/data/tohan_books.json` | A | append | 11KB | 変化なし | トーハン週間ベストセラー（収集基盤） |
| `exp07_satellite/data/tsumagoi_ndvi.csv` | B | append | 3KB | 変化なし | Sentinel-2 AWS公開COG |
| `exp01_jepx/data/spot_2026.csv` | C | append | 1.9MB | OK | JEPX公式CSV |
| `exp01_jepx/data/spot_2025.csv` | C | append | 4.3MB | 変化なし | JEPX公式CSV |
| `exp01_jepx/data/weather_actual.csv` | C | append | 25KB | 変化なし | Open-Meteo archive |
| `exp01_jepx/data/weather_forecast.csv` | C | append | 25KB | OK | Open-Meteo historical-forecast |
...
| `exp02_vegetable/data/veg_34100.csv` | C | append | 148KB | 変化なし | 同上 |
| `exp02_vegetable/data/veg_34400.csv` | C | append | 144KB | 変化なし | 同上 |
