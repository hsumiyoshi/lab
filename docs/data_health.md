...
生成: 2026-09-02 15:03 JST / 登録 26件 / 合計 24.0MB
...
| `collector/data/kyuden_curtail.json` | A | append | 6KB | 変化なし | 九電でんき予報（収集基盤） |
...
| `exp01_jepx/data/spot_2026.csv` | C | append | 1.8MB | 変化なし | JEPX公式CSV |
...
| `exp02_vegetable/data/veg_31700.csv` | C | append | 95KB | OK | 東京都中央卸売市場（ベジ探） |
| `exp02_vegetable/data/veg_33400.csv` | C | append | 97KB | OK | 同上 |
| `exp02_vegetable/data/veg_34100.csv` | C | append | 147KB | OK | 同上 |
| `exp02_vegetable/data/veg_34400.csv` | C | append | 143KB | OK | 同上 |
