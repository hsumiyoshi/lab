...
生成: 2026-08-24 13:39 JST / 登録 26件 / 合計 23.0MB
...
| `exp08_curtail/data/ledger.json` | A | append | 0KB | OK | 自前の採点 |
| `exp10_disaster/data/events.json` | A | append | 838KB | OK | GDACS RSS |
...
| `exp11_books/data/rankings.json` | A | append | 2KB | OK | トーハン週間ベストセラー |
| `exp11_books/data/ledger.json` | A | append | 0KB | 未生成（正常） | 自前の採点 |
| `collector/data/kyuden_curtail.json` | A | append | 2KB | OK | 九電でんき予報（収集基盤） |
| `collector/data/tohan_books.json` | A | append | 3KB | OK | トーハン週間ベストセラー（収集基盤） |
| `exp07_satellite/data/tsumagoi_ndvi.csv` | B | append | 3KB | OK | Sentinel-2 AWS公開COG |
| `exp01_jepx/data/spot_2026.csv` | C | append | 1.7MB | OK | JEPX公式CSV |
| `exp01_jepx/data/spot_2025.csv` | C | append | 4.3MB | OK | JEPX公式CSV |
...
| `exp02_vegetable/data/veg_31700.csv` | C | append | 93KB | OK | 東京都中央卸売市場（ベジ探） |
| `exp02_vegetable/data/veg_33400.csv` | C | append | 96KB | OK | 同上 |
| `exp02_vegetable/data/veg_34100.csv` | C | append | 144KB | OK | 同上 |
| `exp02_vegetable/data/veg_34400.csv` | C | append | 140KB | OK | 同上 |
